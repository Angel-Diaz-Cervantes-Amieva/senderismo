...
class LoginForm(forms.Form):
    username = forms.CharField(max_length=20, widget=forms.TextInput(attrs={"type": "text", "class": "form-control"}))
...
class UserForm(UserCreationForm):
    ...
    password = forms.CharField(max_length=32, widget=forms.PasswordInput(attrs={"type": "password", "class": "form-control"}))
    email = forms.EmailField(max_length=32, widget=forms.EmailInput(attrs={"type": "email", "class": "form-control"}))
